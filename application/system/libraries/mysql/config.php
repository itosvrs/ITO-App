...
/**
 * Require Db.class.php (application/system/libraries/mysql/Db.class.php) used for database connection and queries
 */
 require_once(APP_PATH . DS . 'system/libraries/mysql/Db.class.php');