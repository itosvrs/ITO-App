...
abstract class Smarty_Internal_TemplateBase extends Smarty_Internal_Data {
    ...
    /**
     * Custom method used for load simplicity
     ...
     * @param type $parent 
     */
    public function view($template = null, $cache_id = null, $compile_id = null, $parent = null)
    {
        $this->fetch(WEB_PATH . DS . $template, $cache_id, $compile_id, $parent, true);
    }
